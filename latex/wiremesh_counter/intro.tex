...
%  \begin{subfigure}[b]{0.5\textwidth}
%    \centering
%    \includegraphics[width=2.5in]{../img/maquina/ruebas_dentadas.jpg}
%    \caption{Multiples ruedas dentadas}
%  \end{subfigure}
...
Existen 30 tamaños de estas ruedas %(ver Fig. \ref{deformadora_hm}.c)
